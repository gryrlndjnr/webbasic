    ...
    <section id="full-height" class="full-height">
      ...
      <article id="article" class="spacer">
        <div>
          ...
          <img src="<?= $baseFolder ?>javascriptbasic/images/html.gif" alt="element" class="imageresponsive2" />
          <img src="<?= $baseFolder ?>javascriptbasic/images/css.gif" alt="element" class="imageresponsive2" />
        </div>
        ...
        <div class="spacer">
          ...
          <div>
            <p>
              This course is for complete beginners. HTML and CSS, are Prerequisites
            </p>
            <p>
