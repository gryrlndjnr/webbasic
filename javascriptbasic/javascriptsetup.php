    ...
    <section id="full-height" class="full-height">
      ...
      <article id="article" class="spacer">
        <div>
          ...
          <img src="<?= $baseFolder ?>javascriptbasic/images/vscode.gif" alt="element" class="imageresponsive" />
        </div>

        <hr />
        <div class="spacer">
          <h2>Visual Studio Code</h2>
          <img src="<?= $baseFolder ?>javascriptbasic/images/vscode.png" alt="element" class="imageresponsive" />
          <div>
            <p>
        ...
        <div class="spacer">
          <h2>Node Js</h2>
          <img src="<?= $baseFolder ?>javascriptbasic/images/nodejs.png" alt="element" class="imageresponsive" />
          <p>
            Link: <a href="https://nodejs.org/en" target="_blank">Nodejs.org</a>
          </p>
        </div>
        ...
        <div class="spacer">
          ...
          <img src="<?= $baseFolder ?>javascriptbasic/images/prettier setup.png" alt="element" class="imageresponsive" />
          <p>
