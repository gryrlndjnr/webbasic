    ...
    <section id="full-height" class="full-height">
      ...
      <article id="article" class="spacer">
        <div>
          ...
          <img src="<?= $baseFolder ?>htmlbasic/images/vscode.gif" alt="element" class="imageresponsive" />
        </div>

        <hr />
        <div class="spacer">
          <h2>Visual Studio Code</h2>
          <img src="<?= $baseFolder ?>htmlbasic/images/vscode.png" alt="element" class="imageresponsive" />
          <div>
            <p>
        ...
        <div class="spacer">
          ...
          <img src="<?= $baseFolder ?>htmlbasic/images/prettier.png" alt="element" class="imageresponsive" />
          <p>
        ...
        <div class="spacer">
          ...
          <img src="<?= $baseFolder ?>htmlbasic/images/prettier setup.png" alt="element" class="imageresponsive" />
          <p>
